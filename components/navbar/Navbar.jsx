...
function Navbar() {
  ...
  return (
    <div className={classes.nav_container}>
      <div
        className={!openMenu ? classes.menu_icon : classes.menu_icon_on}
      ...
      />
      <a onClick={hundleOpenRightMenu} className={showSearch ? classes.of : ""}>
        <FontAwesomeIcon
          icon={faBagShopping}
      ...
      <div className={openMenu ? classes.menu : classes.menu_of}>
        <div className={classes.menu_search}>
          <FontAwesomeIcon
            icon={faMagnifyingGlass}
            className={classes.search_icon_menu}
          />
          <input type="text" placeholder="Search apple.com" />
          <FontAwesomeIcon
            icon={faPaperPlane}
            className={classes.send_icon_menu}
          />
        </div>
      ...
      <div
        className={openRightMenu ? classes.right_menu : classes.right_menu_of}
      >
        {state.bag.length > 0 ? (
          <>
            <div className={classes.bag_orders}>
              {state.bag.map((product, i) => (
                <div key={i}>
                  ...
                  <h3>
                    {product.productName} {product.productCapacity}GB{" "}
